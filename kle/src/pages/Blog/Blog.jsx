    ...
    <div className='blog-page'>
        <header className='height-75'>
            <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                ...
                <p className='text-center w-75 mb-5'>Welcome to the CTiE Blog, where we share insights, stories, and updates on innovation, entrepreneurship, and leadership. Dive into expert advice, success stories, and the latest trends shaping the entrepreneurial landscape. Whether you're a budding entrepreneur or a seasoned professional, our blog offers valuable perspectives to inspire and guide you on your journey.</p>
            </div>
        </header>
